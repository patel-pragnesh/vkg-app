...
//        map.addLayer(dynamicMapServiceLayer);
		...
		polygonSymbol = new esri.symbol.SimpleFillSymbol(esri.symbol.SimpleFillSymbol.STYLE_SOLID, new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new dojo.Color([255, 0, 0]), 4), new dojo.Color([255, 255, 0, 0.25]));
...
//			map.graphics.clear();
        ...
        function MO_ra() {
			queryTask = new esri.tasks.QueryTask("https://geoportal.vizugy.hu/arcgis/rest/services/VKG/VKG_modellteruletek/MapServer");
			query = new esri.tasks.Query();
			query.returnGeometry = true;
			query.outFields = ["*"];
